...
class DataFormatter {
  ...
  String addTrailingZeros(String value) {
    if (value == null) {
      return null;
  ...
  String toDate(String value) {
    ...
    return RegExp(r"([0-9]{4}\-[0-9]{2}\-[0-9]{2})").firstMatch(value).group(0);
  }
  ...
  String intToDouble(String value) {
    if (value == null) {
      return value;
    }
    if (isInt(value)) {
  ...
  String handleScientificNotation(num value) {
    if (value == null) {
      return null;
    }
    var sign = "";
  ...
  Color getCurrencyColor(num value, Color bgColor) {
